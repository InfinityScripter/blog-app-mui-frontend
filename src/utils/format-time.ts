 ...
 */
export function fDateTime(date: DateInput, format?: string): string | null {
  if (!date) {
    return null;
  }
...
/** output: 12:00 am
 */
export function fTime(date: DateInput, format?: string): string | null {
  if (!date) {
    return null;
  }
...
/** output: 1713250100
 */
export function fTimestamp(date: DateInput): number | string | null {
  if (!date) {
    return null;
  }
...
/** output: boolean
 */
export function fIsAfter(startDate: DateInput, endDate: DateInput): boolean {
