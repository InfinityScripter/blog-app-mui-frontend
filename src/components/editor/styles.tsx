...
export const StyledRoot = styled(Stack, {
  ...
  return {
    ...
    border: `solid 1px ${varAlpha(vars.palette.grey["500Channel"], 0.2)}`,
    scrollbarWidth: "thin",
    scrollbarColor: `${varAlpha(vars.palette.text.disabledChannel, 0.4)} ${varAlpha(vars.palette.text.disabledChannel, 0.08)}`,
    /**
     * State: error
     */
    ...(error && {
      border: `solid 1px ${vars.palette.error.main}`,
    }),
    /**
     * State: disabled
     */
    ...
    [`& .${editorClasses.content.root}`]: {
      ...
      backgroundColor: varAlpha(vars.palette.grey["500Channel"], 0.08),
      ...(error && {
        backgroundColor: varAlpha(vars.palette.error.mainChannel, 0.08),
      }),
      "& .tiptap": {
        "> * + *": {
          marginTop: 0,
        ...
        [`& .${editorClasses.content.blockquote}`]: {
          ...
          borderLeft: `solid 8px ${varAlpha(vars.palette.grey["500Channel"], 0.08)}`,
        ...
        [`& .${editorClasses.content.codeBlock}`]: {
          ...
          "& pre": {
            ...
            borderRadius: theme.shape.borderRadius,
            backgroundColor: vars.palette.grey[900],
          ...
          [`& .${editorClasses.content.langSelect}`]: {
            ...
            borderColor: varAlpha(vars.palette.grey["500Channel"], 0.08),
            backgroundColor: varAlpha(vars.palette.grey["500Channel"], 0.08),
          },
        },
      },
