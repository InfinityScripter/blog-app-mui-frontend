...
const DEMO = [
  ...
  {
    name: "Progress",
    component: <CarouselProgress data={SLIDES.slice(3, 7)} />,
  },
  {
    name: "Opacity",
    component: <CarouselOpacity data={SLIDES.slice(8, 12)} />,
  },
  { name: "Scale", component: <CarouselScale data={SLIDES.slice(10, 14)} /> },
  {
    name: "Parallax",
    component: <CarouselParallax data={SLIDES.slice(11, 15)} />,
  },
  {
    name: "Right-to-left",
  ...
  {
    name: "Autoplay",
    component: <CarouselAutoplay data={SLIDES.slice(2, 6)} />,
  },
  {
    name: "Auto Scroll",
    component: <CarouselAutoScroll data={SLIDES.slice(3, 7)} />,
  },
  {
    name: "Thumbs-x",
    component: <CarouselThumbsX data={SLIDES.slice(3, 11)} />,
  },
  {
    name: "Thumbs-y",
    component: <CarouselThumbsY data={SLIDES.slice(2, 10)} />,
  },
  {
  ...
  {
    name: "Auto height",
    component: <CarouselAutoHeight data={SLIDES.slice(14, 18)} />,
  },
  { name: "Y-axis", component: <CarouselYaxis data={SLIDES.slice(4, 8)} /> },
  {
    name: "Dots number",
    component: <CarouselDotsNumber data={SLIDES.slice(8, 16)} />,
  },
  {
    name: "Animation",
    component: <CarouselAnimation data={SLIDES.slice(16, 20)} />,
  },
  {
    name: "Customs",
    component: <CarouselCustoms data={SLIDES.slice(8, 14)} />,
  },
];
