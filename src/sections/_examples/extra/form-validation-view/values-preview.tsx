          ...
          {[
            ...
            <div key={item} className={classes.item}>
              ...
              <span className={classes.value}>
                {JSON.stringify(formState[item], null, 2)}
              </span>
            </div>
          ))}
        </Group>
        ...
        <Stack
          ...
          sx={{
            ...
            [`& .${classes.key}`]: {
              ...
              color: "common.white",
              bgcolor: (theme) =>
                varAlpha(theme.vars.palette.common.blackChannel, 0.4),
            },
            [`& .${classes.value}`]: {
              flex: "1 1 auto",
              textAlign: "right",
              bgcolor: (theme) =>
                varAlpha(theme.vars.palette.common.blackChannel, 0.2),
            },
          }}
        >
          {children}
...
function parseValue(values, value) {
  if (value === "singleUpload") {
    return JSON.stringify(
      values.singleUpload && fileData(values.singleUpload),
      null,
      2,
    );
  }
