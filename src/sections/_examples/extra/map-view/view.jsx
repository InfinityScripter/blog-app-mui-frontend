...
const MapHeatmap = dynamic(
  () => import("./heatmap").then((mod) => mod.MapHeatmap),
  {
    loading: () => renderLoading,
  },
);
const MapClusters = dynamic(
  () => import("./clusters").then((mod) => mod.MapClusters),
  {
    loading: () => renderLoading,
  },
);
const MapInteraction = dynamic(
  () => import("./interaction").then((mod) => mod.MapInteraction),
  {
    loading: () => renderLoading,
  },
);
const MapSideBySide = dynamic(
  () => import("./side-by-side").then((mod) => mod.MapSideBySide),
  {
    loading: () => renderLoading,
  },
);
const MapChangeTheme = dynamic(
  () => import("./change-theme").then((mod) => mod.MapChangeTheme),
  {
    loading: () => renderLoading,
  },
);
